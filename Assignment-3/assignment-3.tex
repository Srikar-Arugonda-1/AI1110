...
\begin{document}
	...
	\newcommand{\mydet}[1]{\ensuremath{\begin{vmatrix}#1\end{vmatrix}}}
		...
		\maketitle
		\textbf{Question 12.13.1.8:}
		A die is thrown three times,
		$E$: $4$ appears on third toss, $F$: $6$ and $5$ appears respectively on first two tosses. find $\pr{E \mid F}?$\\\\
		\textbf{Solution}
		$E$: $4$ appears on the third toss\\
		$F$: $6$ and $5$ appears on first and second toss respectively
		\begin{align}
			\pr{E} = \frac{1}{6} 
			\pr{F} = \frac{1}{36}
		\end{align}
